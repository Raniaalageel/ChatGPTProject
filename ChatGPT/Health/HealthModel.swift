...
extension HealthModel {
    static func getMock() -> [HealthModel]{
        return  [
            ...
            HealthModel(title: "Certified Clinical Research Associate(CCRA)", image: "CCRA", url: "647927bc-b2bd-49eb-a2db-8424fdee66df-151215125404-thumbnail-removebg-preview")
        ]
